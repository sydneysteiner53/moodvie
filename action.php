...
$content = file_get_contents("http://www.imdb.com/search/title?genres=action&title_type=feature&sort=moviemeter,asc");
...
<a class="btn" style="color: #999;" href = "action.php"> Adventurous </a>
<a class="btn" href = "romance.php"> Lonely </a>
<br><br>
